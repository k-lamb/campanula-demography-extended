#!/usr/bin/bash
#SBATCH -J onepop_All # A single job name for the array
#SBATCH -n 1
#SBATCH -t 8:00:00
#SBATCH --mem 8G
#SBATCH -o /home/ksl2za/automation_dadi/All/ONE_POP_projected/out/out_%j.out
#SBATCH -e /home/ksl2za/automation_dadi/All/ONE_POP_projected/error/error_%j.error
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-300 run_dadi_pairs_ONEPOP.sh
...
cd /home/ksl2za/automation_dadi/All/ONE_POP_projected
python All_moments_onepop.py \
$iter \
$Pair \
$pop1 \
$pop2 \
