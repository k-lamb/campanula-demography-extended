#!/usr/bin/bash
#SBATCH -J nomig_All # A single job name for the array
#SBATCH -n 1
#SBATCH -t 8:00:00
#SBATCH --mem=8G
#SBATCH -o /home/ksl2za/automation_dadi/All/NO_MIG_projected/out/out_%j.out
#SBATCH -e /home/ksl2za/automation_dadi/All/NO_MIG_projected/error/error_%j.error
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-300 run_dadi_pairs_NOMIG.sh
...
cd /home/ksl2za/automation_dadi/All/NO_MIG_projected
python All_moments_nomig.py \
$iter \
$Pair \
$pop1 \
$pop2 \
